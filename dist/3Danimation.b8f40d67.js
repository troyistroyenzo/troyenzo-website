...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"assets/js/3Danimation.js":[function(require,module,exports) {
//Movement Animation
card = document.querySelector(".card");
container = document.querySelector(".container__3d"); //Moving Animation Event

container.addEventListener("mousemove", function (e) {
  console.log("hey");
  console.log(e.pageX, e.pageY);
  var xAxis = (window.innerWidth / 2 - e.pageX) / 51;
  var yAxis = (window.innerHeight / 2 - e.pageY) / 51;
  card.style.transform = "rotateY(".concat(xAxis, "deg) rotateX(").concat(yAxis, "deg)");
}); //Items

title = document.querySelector('.title');
subtitle = document.querySelector('.subtitle');
phone = document.querySelector('.phone iframe');
...
colors = document.querySelector('.colors'); //Animate In
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","assets/js/3Danimation.js"], null)
//# sourceMappingURL=/3Danimation.b8f40d67.js.map